    ...
    var body: some View {
        VStack {
            ...
            Text("Enter your weight")
                ...
                .padding(.top, 24)
            TextField("", text: $weight, prompt: Text("Tap to write").foregroundColor(Color.init(red: 127/255, green: 137/255, blue: 149/255)).font(.system(size: 22, weight: .regular, design: .default)))
...
#Preview {
    FillWeightScreen(path: .constant(.init()))
}
