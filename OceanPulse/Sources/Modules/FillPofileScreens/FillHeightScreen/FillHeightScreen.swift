    ...
    var body: some View {
        VStack {
            ...
            Text("Enter your height")
                ...
                .padding(.top, 24)
            TextField("", text: $height, prompt: Text("Tap to write").foregroundColor(Color.init(red: 127/255, green: 137/255, blue: 149/255)).font(.system(size: 22, weight: .regular, design: .default)))
...
#Preview {
    FillHeightScreen(path: .constant(.init()))
}
